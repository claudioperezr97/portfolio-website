...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-28 max-w-[45rem] leading-8 text-center scroll-mt-28"
    ...
    >
      ...
      <p className="mb-4">
        ...
        <span className="font-medium">
          React, React Native, Node.js, Express.js and postreSQL
        </span>
        . I am also familiar with TypeScript. I am always looking to learn new
        technologies. I am currently looking for a{" "}
        <span className="font-medium">entry level front-end position</span> as a
        software developer.
      </p>
